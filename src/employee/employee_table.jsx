...
import UnfoldMoreIcon from '@material-ui/icons/UnfoldMore';const useStyles = makeStyles(theme => ({
  root: {
    width: '100%',
  },
  paper: {
...
const rows = [
  ...
  createData(3, 'Mithusan', 'QA', 'mithusan@gmail.com'),
  createData(4, 'Mathusanth', 'QA', 'mathusanth@gmail.com'),
  createData(5, 'Sathurjan', 'HR', 'sathun@gmail.com'),
];
          ...
          <TableBody>
            {rows.map(row => (
              <TableRow key={row.id}>
                ...
                <TableCell align="right">{row.edit} <i><EditIcon/></i> </TableCell>
